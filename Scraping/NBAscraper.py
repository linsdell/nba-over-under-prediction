...
def getListOfTeams():
    ...
    result = requests.get("https://www.teamrankings.com/nba/stat/shooting-pct?date=2019-10-24")
    src = result.content
...
def getDataForStatOnDay(statID,date):
    data_url = "https://www.teamrankings.com/nba/stat/"+statID+"?date="+str(date)
...
for i in range(0,(end_date-start_date).days): # TODO: date in date range
    ...
    for feature in selected_features:
        stats_on_day = getDataForStatOnDay(feature,current_date) # TODO: replace with data
